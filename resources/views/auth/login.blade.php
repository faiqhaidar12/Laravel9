    ...
    <div class="container d-flex flex-column justify-content-between vh-100">
                    ...
                    <div class="card-header bg-primary">
                        <div class="app-brand">
                            <a href="{{ url('/') }}">
                                ...
                                <span class="brand-name">Toko Dashboard</span>
                            </a>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="d-flex my-2 justify-content-between">
                                        ...
                                        <p><a class="text-blue" href="{{ route('password.request') }}">Forgot
                                                Your Password?</a></p>
                                    </div>
        ...
        <div class="copyright pl-0">
            <p class="text-center">&copy; 2018 Copyright by
                <a class="text-primary" href="http://www.toko.com/" target="_blank">Fa'iq</a>.
            </p>
        </div>
    </div>
</body>
